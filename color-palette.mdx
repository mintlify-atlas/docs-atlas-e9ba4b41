...
|---|---|---|
| Yellow-green | `#b8bb26` | Strings, active tab indicator border, Activity Bar active icon, status bar remote item, panel title border, input active border |
| Red | `#fb5245` | Keywords, storage modifiers, HTML tags, CSS selectors, error markers |
| Teal | `#8ec07c` | Operators, Class/Support types, HTML punctuation, Python class methods |
